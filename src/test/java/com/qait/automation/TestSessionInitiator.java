...
import com.skyfactor.keywords.SkyfactorHomePageActions;
import com.skyfactor.keywords.SkyfactorLoginPageActions;
import com.skyfactor.keywords.SkyfactorStaticListsPageActions;
import com.skyfactor.keywords.YamlInformationProvider;
...
public class TestSessionInitiator {
	...
	public SkyfactorLoginPageActions skyfactorLoginPage;
	public SkyfactorHomePageActions skyfactorHomePage;
	public SkyfactorStaticListsPageActions skyfactorStaticListsPage; 
	...
	private void _initPage() {
		...
		skyfactorHomePage = new SkyfactorHomePageActions(driver);
		skyfactorLoginPage = new SkyfactorLoginPageActions(driver);
		//hbsSecureHomePage = new skyfactorHomePageActions(driver);
		skyfactorStaticListsPage = new SkyfactorStaticListsPageActions(driver);
